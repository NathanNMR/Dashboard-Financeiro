  ...
  return (
    <div className="grid grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-6">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-6 shadow-xl relative overflow-hidden">
        ...
        <div className="text-lg sm:text-3xl font-bold break-words text-emerald-400 mt-2">{formatCurrency(totalIncome)}</div>
      </div>
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-6 shadow-xl relative overflow-hidden">
        ...
        <div className="text-lg sm:text-3xl font-bold break-words text-rose-400 mt-2">{formatCurrency(totalExpense)}</div>
      </div>
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-6 shadow-xl relative overflow-hidden">
        ...
        <div className={`text-lg sm:text-3xl font-bold break-words mt-2 ${balance >= 0 ? "text-cyan-400" : "text-amber-400"}`}>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-6 shadow-xl relative overflow-hidden">
        ...
        {topCategory ? (
          <>
            <div className="text-lg sm:text-2xl font-bold text-slate-100 mt-2">
