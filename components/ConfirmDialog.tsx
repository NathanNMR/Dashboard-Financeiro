...
export function useConfirmDialog() {
  ...
  const dialog = options ? (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-sm p-4">
      <div className="bg-slate-900 border border-slate-800 rounded-xl shadow-lg shadow-black/40 max-w-sm w-full p-6 space-y-4">
        ...
        <div className="flex justify-end gap-3 pt-2">
          ...
          <button
            onClick={() => handle(true)}
            className="px-4 py-2 rounded-xl text-sm font-medium bg-rose-600 hover:bg-rose-500 text-white transition"
          >
